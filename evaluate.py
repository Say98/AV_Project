...
print("beard_confusion_matrix\n", beard_confusion_matrix)
print("moustache_confusion_matrix\n", moustache_confusion_matrix)
print("glasses_confusion_matrix\n", glasses_confusion_matrix)

metric_names = ["beard_accuracy", "beard_balanced_accuracy", "moustache_accuracy", "moustache_balanced_accuracy", 
    "glasses_accuracy", "glasses_balanced_accuracy", "avg_accuracy", "avg_balanced_accuracy", "fas"]

metrics = [beard_accuracy, beard_balanced_accuracy, moustache_accuracy, moustache_balanced_accuracy, 
    glasses_accuracy, glasses_balanced_accuracy, avg_accuracy, avg_balanced_accuracy, fas]
metrics = [round(metric, 3) for metric in metrics]

t = PrettyTable()
t.add_column("Metric", metric_names)
t.add_column("Value", metrics)
print(t)